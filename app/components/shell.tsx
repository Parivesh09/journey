...
export default async function AppShell({
  ...
  return (
    <div className="min-h-screen flex flex-col gap-6 bg-ink text-bone">
      <header className="sticky top-0 z-40 border-b border-stone-400 bg-[#101927]/80 backdrop-blur-sm">
      ...
      {user ? (
        <div className="flex items-center justify-between gap-3 border-t border-stone-400 bg-[#101927]/80 px-5 py-3 lg:hidden">
